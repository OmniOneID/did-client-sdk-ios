...
3. **Publishing the Integrated Release**  
   ...
   | ------------------ | --------------- | --------------------------- | --------------------------- |
   | did-ca-ios         | V2.0.2          | [Changelog](https://github.com/OmniOneID/did-ca-ios/blob/main/CHANGELOG.md) |
   | did-client-sdk-ios | V2.0.2          | [Changelog](https://github.com/OmniOneID/did-client-sdk-ios/blob/main/CHANGELOG.md) |
   | ..                 | ..              | ..                           |
