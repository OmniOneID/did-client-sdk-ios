...
extension CBOR {
    static func encode<T: CBOREncodable>(_ value: T, options: CBOROptions = CBOROptions()) -> [UInt8] {
    ...
    static func encode<T: CBOREncodable>(_ array: [T], asByteString: Bool = false, options: CBOROptions = CBOROptions()) -> [UInt8] {
        if asByteString {
    ...
    static func encode<A: CBOREncodable, B: CBOREncodable>(_ dict: [A: B], options: CBOROptions = CBOROptions()) -> [UInt8] {
        return encodeMap(dict, options: options)
    }

    // MARK: - major 0: unsigned integer

    static func encodeUInt8(_ x: UInt8) -> [UInt8] {
        if (x < 24) { return [x] }
        else { return [0x18, x] }
    }

    static func encodeUInt16(_ x: UInt16) -> [UInt8] {
        return [0x19] + rawBytes(of: x)
    }

    static func encodeUInt32(_ x: UInt32) -> [UInt8] {
        return [0x1a] + rawBytes(of: x)
    }

    static func encodeUInt64(_ x: UInt64) -> [UInt8] {
    ...
    static func encodeNegativeInt(_ x: Int64) -> [UInt8] {
        assert(x < 0)
    ...
    static func encodeByteString(_ bs: [UInt8], options: CBOROptions = CBOROptions()) -> [UInt8] {
    ...
    #if canImport(Foundation)
    static func encodeData(_ data: Data, options: CBOROptions = CBOROptions()) -> [UInt8] {
    ...
    static func encodeString(_ str: String, options: CBOROptions = CBOROptions()) -> [UInt8] {
    ...
    static func encodeArray<T: CBOREncodable>(_ arr: [T], options: CBOROptions = CBOROptions()) -> [UInt8] {
    ...
    static func encodeMap<A: CBOREncodable, B: CBOREncodable>(_ map: [A: B], options: CBOROptions = CBOROptions()) -> [UInt8] {
    ...
    static func encodeMap<A: CBOREncodable>(_ map: [A: Any?], options: CBOROptions = CBOROptions()) throws -> [UInt8] {
        if options.forbidNonStringMapKeys {
            try ensureStringKey(A.self)
        }
        var res: [UInt8] = []
	...
	static func encodeCBORMap(_ map: OrderedDictionary<CBOR, CBOR>, options: CBOROptions = CBOROptions()) -> [UInt8] {
		var res: [UInt8] = []
		res = map.count.encode(options: options)
		res[0] = res[0] | 0b101_00000
    ...
    static func encodeTagged<T: CBOREncodable>(tag: Tag, value: T, options: CBOROptions = CBOROptions()) -> [UInt8] {
    ...
    static func encodeSimpleValue(_ x: UInt8) -> [UInt8] {
        if x < 24 {
    ...
    static func encodeNull() -> [UInt8] {
        return [0xf6]
    }

    static func encodeUndefined() -> [UInt8] {
        return [0xf7]
    }

    static func encodeBreak() -> [UInt8] {
        return [0xff]
    }

    static func encodeFloat(_ x: Float) -> [UInt8] {
        return [0xfa] + rawBytes(of: x)
    }

    static func encodeDouble(_ x: Double) -> [UInt8] {
        return [0xfb] + rawBytes(of: x)
    }

    static func encodeBool(_ x: Bool) -> [UInt8] {
        return x ? [0xf5] : [0xf4]
    }
    ...
    static func encodeArrayStreamStart() -> [UInt8] {
        return [0x9f]
    }

    static func encodeMapStreamStart() -> [UInt8] {
        return [0xbf]
    }

    static func encodeStringStreamStart() -> [UInt8] {
        return [0x7f]
    }

    static func encodeByteStringStreamStart() -> [UInt8] {
        return [0x5f]
    }

    /// This is the same as a CBOR "break" value
    static func encodeStreamEnd() -> [UInt8] {
        return [0xff]
    }

    // TODO: unify definite and indefinite code
    static func encodeArrayChunk<T: CBOREncodable>(_ chunk: [T], options: CBOROptions = CBOROptions()) -> [UInt8] {
        var res: [UInt8] = []
    ...
    static func encodeMapChunk<A: CBOREncodable, B: CBOREncodable>(_ map: [A: B], options: CBOROptions = CBOROptions()) -> [UInt8] {
        if options.forbidNonStringMapKeys {
            try! ensureStringKey(A.self)
        }
        var res: [UInt8] = []
    ...
    #if canImport(Foundation)
    static func encodeDate(_ date: Date, options: CBOROptions = CBOROptions()) -> [UInt8] {
    ...
    static func encodeAny(_ any: Any?, options: CBOROptions = CBOROptions()) throws -> [UInt8] {
        switch any {
        case is Int:
        ...
        default:
            ...
            // Vendored: the upstream `Codable` fallback is dropped along with the Codable layer.
