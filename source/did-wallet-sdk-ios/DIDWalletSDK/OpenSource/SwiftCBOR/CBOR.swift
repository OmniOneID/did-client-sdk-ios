...
indirect enum CBOR : Equatable, Hashable, Sendable,
    ...
    init(extendedGraphemeClusterLiteral value: String) { self = .utf8String(value) }
    init(unicodeScalarLiteral value: String) { self = .utf8String(value) }
    init(stringLiteral value: String) { self = .utf8String(value) }
    init(arrayLiteral elements: CBOR...) { self = .array(elements) }
    init(dictionaryLiteral elements: (CBOR, CBOR)...) {
    ...
    init(floatLiteral value: Float32) { self = .float(value) }
    ...
    struct Tag: RawRepresentable, Hashable, Sendable {
        let rawValue: UInt64
